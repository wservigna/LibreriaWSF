...
namespace WSF.WebApi.Controllers.Dynamic.Interceptors
{
    /// <summary>
    ...
    public class WSFDynamicApiControllerInterceptor<T> : IInterceptor
    {
        /// <summary>
