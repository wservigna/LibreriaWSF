...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use WSF system.
    /// </summary>
    public abstract class WSFApiController : ApiController
    {
        /// <summary>
