...
namespace WSF
{
    ...
    public class DateTimeRange : IDateTimeRange
    {
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="WSF.DateTimeRange"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="WSF.DateTimeRange"/>.</returns>
