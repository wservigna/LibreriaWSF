...
namespace WSF.Runtime.Validation.Interception
{
    /// <summary>
    ...
    internal class MethodInvocationValidator
    {
        ...
        public void Validate()
        {
            ...
            {
                throw new WSFValidationException("Method arguments are not valid! See ValidationErrors for details.") { ValidationErrors = _validationErrors };
            }
