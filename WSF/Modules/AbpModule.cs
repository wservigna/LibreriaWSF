...
namespace WSF.Modules
{
    ...
    /// </remarks>
    public abstract class WSFModule
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets a reference to the WSF configuration.
        /// </summary>
        protected internal IWSFStartupConfiguration Configuration { get; internal set; }
        ...
        /// <summary>
        /// Checks if given type is an WSF module class.
        /// </summary>
        /// <param name="type">Type to check</param>
        public static bool IsWSFModule(Type type)
        {
            return
                type.IsClass &&
                !type.IsAbstract &&
                typeof(WSFModule).IsAssignableFrom(type);
        }
