...
using WSF.Localization.Dictionaries.Xml;

namespace WSF.Localization.Sources.Xml
{
    /// <summary>
    ...
    public class XmlLocalizationSource : DictionaryBasedLocalizationSource, ISingletonDependency
    {
        ...
        public override void Initialize()
        {
            ...
            {
                throw new WSFException("Can not find default localization file for source " + Name + ". A source must contain a source-name.xml file as default localization.");
            }
