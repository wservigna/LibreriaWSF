...
using WSF.Localization.Dictionaries;

namespace WSF.Localization.Sources
{
    /// <summary>
    ...
    public class DictionaryBasedLocalizationSource : ILocalizationSource
    {
        ...
        public string GetString(string name, CultureInfo culture)
        {
            ...
            {
                throw new WSFException("Can not find '" + name + "' and no default language is defined!");
            }
            ...
            throw new WSFException("Can not find a localized string for '" + name + "' in source '" + Name + "'!");
        }
        ...
        public IReadOnlyList<LocalizedString> GetAllStrings(CultureInfo culture)
        {
            if (_defaultDictionary == null)
            {
                throw new WSFException("No default dictionary is defined!");
            }
