...
using WSF.WebApi.Controllers.Dynamic.Scripting.Angular;
using WSF.WebApi.Controllers.Dynamic.Scripting.jQuery;

namespace WSF.WebApi.Controllers.Dynamic.Scripting
{
    ...
    public class ScriptProxyManager : ISingletonDependency
    {
        ...
        private static IScriptProxyGenerator CreateProxyGenerator(ProxyScriptType type, DynamicApiControllerInfo controllerInfo, bool amdModule)
        {
            switch (type)
            {
                ...
                default:
                    throw new WSFException("Unknown ProxyScriptType: " + type);
            }
        }
