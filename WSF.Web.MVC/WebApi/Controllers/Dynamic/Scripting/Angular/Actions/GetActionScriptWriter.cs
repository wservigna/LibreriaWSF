...
namespace WSF.WebApi.Controllers.Dynamic.Scripting.Angular.Actions
{
    internal class GetActionScriptWriter : ActionScriptWriter
    {
        public GetActionScriptWriter(DynamicApiControllerInfo controllerInfo, DynamicApiActionInfo methodInfo)
