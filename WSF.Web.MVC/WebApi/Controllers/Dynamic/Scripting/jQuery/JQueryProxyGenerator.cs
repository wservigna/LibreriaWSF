...
using WSF.WebApi.Controllers.Dynamic.Scripting.jQuery.Actions;

namespace WSF.WebApi.Controllers.Dynamic.Scripting.jQuery
{
    internal class JQueryProxyGenerator : IScriptProxyGenerator
    {
        ...
        public string Generate()
        {
            ...
            script.AppendLine();
            script.AppendLine("    var serviceNamespace = WSF.utils.createNamespace(WSF, 'services." + _controllerInfo.ServiceName.Replace("/", ".") + "');");
            script.AppendLine();
