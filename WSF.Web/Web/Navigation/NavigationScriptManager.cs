...
namespace WSF.Web.Navigation
{
    internal class NavigationScriptManager : INavigationScriptManager, ISingletonDependency
    {
        ...
        {
            var userMenus = await _userNavigationManager.GetMenusAsync(WSFSession.UserId);

            var sb = new StringBuilder();
            sb.AppendLine("(function() {");

            sb.AppendLine("    WSF.nav = {};");
            sb.AppendLine("    WSF.nav.menus = {");
